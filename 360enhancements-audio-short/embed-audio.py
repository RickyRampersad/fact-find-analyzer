#!/usr/bin/env python3
"""Fold the narration MP3s into 360enhancements-short.html as data URIs.
...
the SCENES and CUES tables in 360enhancements-short.html can be checked against the audio that
is actually in it.
"""
import base64, pathlib, re, sys

here = pathlib.Path(__file__).parent
film = here.parent / '360enhancements-short.html'
...
if start not in html or end not in html:
    sys.exit('Markers missing in 360enhancements-short.html — nothing was changed.')
...
print(f'360enhancements-short.html is now {len(html)/1024:.0f} KB')
